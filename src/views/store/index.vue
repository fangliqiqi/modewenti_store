      ...
      >
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <!-- <el-form-item label="市场价：">
                <span>{{ props.row.otPricelist }}</span>
              </el-form-item>
              <el-form-item label="成本价：">
                <span>{{ props.row.costlist }}</span>
              </el-form-item> -->
        ...
        <el-table-column label="操作" min-width="120" fixed="right" align="center">
          <template slot-scope="scope">
            ...
            <el-button  v-if="tableFrom.type === '5'" type="text" size="small" @click="handleRestore(scope.row.id, tableFrom.type)">恢复商品</el-button>
  ...
  methods: {
    ...
    getCategorySelect() {
      categoryApi({ status: -1, type: 1 }).then(res => {
        this.merCateList = this.$treeFormat(res,'child')
      }).catch(res => {
        this.$message.error(res.message)
      })
    },
