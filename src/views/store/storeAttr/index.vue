    ...
    <el-card class="box-card">
      ...
      >
        ...
        >
          ...
          <template slot-scope="scope">
            <template v-if="typeof scope.row.ruleValue == 'object'">
              <div  v-for="(item, index) in scope.row.ruleValue" :key="index"  class="mr10" v-text="item.value">
              </div>
            </template>
            <div v-else >
              {{scope.row.ruleValue}}
          ...
          <template slot-scope="scope">
            <template v-if="typeof scope.row.ruleValue == 'object'">
              <div  v-for="(item, index) in scope.row.ruleValue" :key="index" >
                {{item.detail&&item.detail.length>0?item.detail.join(','):item}}
              </div>
            </template>
            <div v-else >
              {{scope.row.ruleValue}}
