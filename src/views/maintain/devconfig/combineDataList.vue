<template>
  <div class="components-container">
    ...
    <el-pagination
      :current-page="listPram.pageNo"
      :page-sizes="constants.page.pageSize"
  ...
  data() {
    return {
      ...
      listPram: {
        ...
        pageNo: 1,
        pageSize: this.$constants.page.pageSize[0]
      },
      editDataConfig: {
        visible: false,
  ...
  methods: {
    ...
    handlerGetListData(pram) { // 获取列表数据
      systemGroupDataApi.groupDataList(pram).then(data => {
        ...
        this.dataList.total = data.totalRows
      })
    },
