  ...
  export default {
    ...
    methods: {
      ...
      getListSpread() {
        ...
        spreadListApi({ page: this.spreadFrom.page, pageSize: this.spreadFrom.limit}, this.spreadFrom).then(res => {
      ...
      getSpreadOrderList() {
        this.spreadLoading = true
        spreadOrderListApi({ page: this.spreadFrom.page, pageSize: this.spreadFrom.limit}, this.spreadFrom).then(res => {
          this.spreadData.data = res.list
          this.spreadData.total = res.total
          this.spreadLoading = false
        }).catch(() => {
