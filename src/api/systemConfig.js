...
export function configDelete(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/delete',
    method: 'GET',
    params: data
  })
}
...
export function configList(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/list',
    method: 'GET',
    params: data
  })
}
...
export function configSave(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/save',
    method: 'POST',
    params: data
  })
}
...
export function configUpdate(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/update',
    method: 'POST',
    params: data
  })
}
...
export function configSaveUniq(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/saveuniq',
    method: 'POST',
    params: data
  })
}
...
export function configGetUniq(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/config/getuniq',
    method: 'GET',
    params: data
  })
}
