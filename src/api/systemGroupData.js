...
export function groupDataDelete(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/group/data/delete',
    method: 'GET',
    params: data
  })
}
...
export function groupDataInfo(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/group/data/info',
    method: 'GET',
    params: data
  })
}
...
export function groupDataList(pram) {
  ...
  return request({
    url: '/shop-api/admin/system/group/data/list',
    method: 'GET',
    params: data
  })
}
...
export function groupDataSave(pram) {
  return request({
    url: '/shop-api/admin/system/group/data/save',
    method: 'POST',
    data: pram
  })
}
...
export function groupDataEdit(pram, id) {
  return request({
    url: '/shop-api/admin/system/group/data/update',
    method: 'POST',
    data: pram,
    params: { id: id }
  })
